<div id="menu">
	<ul>
		...
		<li><a href="shoplist" class="<?php if ($_SERVER["REQUEST_URI"] == '/shoplist'){echo 'selected';}?>"><span class="icon medium shopCart"></span> Shopping list</a></li>
		...
		<li><a href="my" class="<?php if ($_SERVER["REQUEST_URI"] == '/my'){echo 'selected';}?>"><span class="icon medium user"></span> My account</a></li>
